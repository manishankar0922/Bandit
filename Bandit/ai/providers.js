...
(function (root) {
  const PROVIDERS = {
    ...
    nvidia:    { endpoint: 'https://integrate.api.nvidia.com/v1/chat/completions', auth: 'bearer', model: 'meta/llama-3.3-70b-instruct', format: 'openai' }, // NIM is also OpenAI-compatible
  };
