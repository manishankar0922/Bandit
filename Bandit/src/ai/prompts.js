// System prompts shared by both AI features.
//
// Design notes:
...
//  - Few-shot anchor: one tiny input→output example pins the format.
...
//  - ABSOLUTE OUTPUT RULES: enforces minimum response quality.
...
const TONE_MODIFIERS = {
  professional: '', // default — no modifier needed
...
export const SUMMARIZE_SYSTEM = `You are an expert scribe. Summarize this AI chat session into a context brief the user will paste into a NEW chat so the next AI can continue the work without re-asking anything.
...
// Combines a style template with a tone modifier and custom instructions.
export function buildSystemPrompt(style, tone, customInstructions = '') {
